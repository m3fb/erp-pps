...
<div class="m3-termine-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
				...
				return $user->firstname ." " .$user->surename;
        ...
        'panel' => [
			'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-calendar"></i>&nbsp; Termine für den Procontrol-Kundenmodus</b></h3>',
			'type'=>'primary',
    ...
    <div>
      Aktueller Stand: <?= ($kundentermin ==1) ? Html::encode('Kundenmodus aktiv') : Html::encode('Kundenmodus nicht aktiv') ?>
    </div>
