...
###### - Abfrage nach ersten 200er Eintrag evtl überfällig 
    ...
    if($sm == 1){
		...
		if($type['STATUS'] == 200){
			...
			else if($merk_spaet && $zeit_sek < $timestamp_spaetschicht){
				$gesamtzeit = $gesamtzeit + 0;
			}
			else if($merk_nacht && $zeit_sek < $timestamp_nachtschicht){
				$gesamtzeit = $gesamtzeit + 0;
			}
			...
			// Startzeit vor 20 Uhr und Endzeit zw 0 und 6 Uhr
